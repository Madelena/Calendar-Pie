...
These provisioning flows, LAN authentication, automatic service startup, and enclosure behavior are design goals rather than implemented features. Current operation and limitations are documented in [DEPLOYMENT.md](DEPLOYMENT.md), while longer-term work remains in [PLAN.md](PLAN.md).
